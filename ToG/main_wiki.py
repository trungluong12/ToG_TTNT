    ...
    for data in tqdm(datas[12:19]):
        ...
        for depth in range(1, args.depth+1):
            ...
            for entity in topic_entity:
                if entity!="[FINISH_ID]":
                    retrieve_relations_with_scores, entity_names, entity_ids, id_to_label, label_to_id = relation_search_prune_API(entity, topic_entity[entity], pre_relations, pre_heads[i], question, args, wiki_client)  # best entity triplet, entitiy_id
