...
Important note: Only retrieve relations that in the Relations list of the question.
...
prompt_evaluate_wiki="""Given a question and the associated retrieved knowledge graph triplets (entity, relation, entity), you are asked to answer whether it's sufficient for you to answer the question with these triplets and your knowledge (Yes or No). Here are the details intructions:
* If the information is sufficient, respond with "Yes" and provide the reasoning and the final answer inside {}.
* If the information is insufficient, respond with "No" and explain why additional details are required.
...
3. {wiki.relation.position_held (Score: 0.1)}: This relation is moderately relevant as it can provide information about any significant positions held by Mesih Pasha or his uncle that could be related to becoming an emperor.
