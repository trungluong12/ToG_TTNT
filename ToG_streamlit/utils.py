...
def run_llm(prompt, temperature, max_tokens, google_api_key, model_name="gemini-pro"):
    time.sleep(2)
...
def prepare_dataset(dataset_name):
    if dataset_name == 'cwq':
        with open('/mnt/d/KHDL/Paper/RAG/ToG-main/ToG-main/data/cwq.json',encoding='utf-8') as f:
            datas = json.load(f)
